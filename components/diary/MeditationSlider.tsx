...
export default function MeditationSlider({ onChange }: MeditationSliderProps) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%' }}>
      ...
      <style>{`
        input[type=range]::-webkit-slider-thumb { appearance: none; -webkit-appearance: none; width: 20px; height: 20px; border-radius: 50%; background: white; box-shadow: 0 0 10px rgba(196,181,253,0.5), 0 2px 4px rgba(0,0,0,0.3); cursor: pointer; }
